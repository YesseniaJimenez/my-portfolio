    ...
    <section id="contact" className="contact">
      <div className="container">
        ...
        <p className="contact-cta">
          ...
          challenges. If you’re looking for a developer who enjoys building
          clean, scalable solutions, feel free to reach out. I’d love to connect
          and talk about how we can work together.
        </p>
